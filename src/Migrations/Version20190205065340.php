 ...
 */
final class Version20190205065340 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE spot_like (id INT AUTO_INCREMENT NOT NULL, spot_id INT DEFAULT NULL, user_id INT DEFAULT NULL, INDEX IDX_595ECE402DF1D37C (spot_id), INDEX IDX_595ECE40A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE spot_like ADD CONSTRAINT FK_595ECE402DF1D37C FOREIGN KEY (spot_id) REFERENCES spot (id)');
        $this->addSql('ALTER TABLE spot_like ADD CONSTRAINT FK_595ECE40A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE spot_like DROP FOREIGN KEY FK_595ECE402DF1D37C');
        ...
        $this->addSql('ALTER TABLE spot_like DROP FOREIGN KEY FK_595ECE40A76ED395');
        $this->addSql('ALTER TABLE user_role DROP FOREIGN KEY FK_2DE8C6A3A76ED395');
        $this->addSql('DROP TABLE location');
        $this->addSql('DROP TABLE role');
        $this->addSql('DROP TABLE spot');
        $this->addSql('DROP TABLE spot_like');
